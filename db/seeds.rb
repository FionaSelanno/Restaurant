...
ramon = User.create(name:"Ramon", email:"ramon@test.nl", phone:"06-11111111")
steven = User.create(name:"Steven", email:"steven@test.nl", phone:"06-21111111")
fiona = User.create(name:"Fiona", email:"fiona@test.nl", phone:"06-31111111")
